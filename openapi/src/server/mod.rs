...
where
    ...
    A: apis::author::Author + apis::book::Book + apis::discount::Discount + apis::store::Store + apis::ApiKeyAuthHeader<Claims = C> + 'static,
    
{
    ...
    Router::new()
        ...
        .route("/api/v1/author/:author_id",
            delete(delete_author::<I, A>).get(get_author_by_id::<I, A>).patch(update_author::<I, A>)
        )
        .route("/api/v1/book",
            post(add_book::<I, A>)
        )
        .route("/api/v1/book/:book_id",
            delete(delete_book::<I, A>).get(get_book_by_id::<I, A>).patch(update_book::<I, A>)
        )
        .route("/api/v1/book/findByAuthorId",
            get(get_books_by_authors::<I, A>)
        )
        .route("/api/v1/book/findbyGenereId",
            get(get_books_by_generes::<I, A>)
        )
        .route("/api/v1/book/findbyStatus",
            get(get_books_by_status::<I, A>)
        )
        .route("/api/v1/discount",
            post(add_discount::<I, A>)
        )
        .route("/api/v1/discount/:discount_id",
            delete(delete_discount::<I, A>).get(get_discount_by_id::<I, A>).patch(update_discount::<I, A>)
        )
        .route("/api/v1/store/inventory",
            get(get_inventory::<I, A>)
        )
        .route("/api/v1/store/order",
            post(place_order::<I, A>)
        )
        .route("/api/v1/store/order/:order_id",
            delete(delete_order::<I, A>).get(get_order_by_id::<I, A>).patch(update_order::<I, A>)
        )
        .with_state(api_impl)
}
    ...
    A: apis::author::Author,
{
  ...
  let result = api_impl.as_ref().add_author(
      method,
      host,
      cookies,
              body,
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::author::AddAuthorResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
    ...
    A: apis::author::Author,
{
  ...
  let result = api_impl.as_ref().delete_author(
      method,
      host,
      cookies,
        path_params,
...
fn get_author_by_id_validation(
  ...
  models::GetAuthorByIdPathParams,
), ValidationErrors>
{
  path_params.validate()?;
    ...
    A: apis::author::Author,
{
  ...
  let result = api_impl.as_ref().get_author_by_id(
      method,
      host,
      cookies,
        path_params,
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::author::GetAuthorByIdResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
...
fn update_author_validation(
  ...
  models::UpdateAuthorPathParams,
        models::AuthorProperties,
), ValidationErrors>
{
  path_params.validate()?;
    ...
    A: apis::author::Author,
{
  ...
  let result = api_impl.as_ref().update_author(
      method,
      host,
      cookies,
        path_params,
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::author::UpdateAuthorResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
    ...
    A: apis::book::Book,
{
  ...
  let result = api_impl.as_ref().add_book(
      method,
      host,
      cookies,
              body,
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::book::AddBookResponse::Status201_SuccessfulOperation
                                                    (body)
                                                => {
    ...
    A: apis::book::Book,
{
  ...
  let result = api_impl.as_ref().delete_book(
      method,
      host,
      cookies,
        path_params,
    ...
    A: apis::book::Book,
{
  ...
  let result = api_impl.as_ref().get_book_by_id(
      method,
      host,
      cookies,
        path_params,
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::book::GetBookByIdResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
...
fn get_books_by_authors_validation(
  ...
  models::GetBooksByAuthorsQueryParams,
), ValidationErrors>
{
    ...
    A: apis::book::Book,
{
      ...
      #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    get_books_by_authors_validation(
        query_params,
    )
  ).await.unwrap();
  ...
  let result = api_impl.as_ref().get_books_by_authors(
      method,
      host,
      cookies,
        query_params,
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::book::GetBooksByAuthorsResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
...
fn get_books_by_generes_validation(
  ...
  models::GetBooksByGeneresQueryParams,
), ValidationErrors>
{
  query_params.validate()?;
    ...
    A: apis::book::Book,
{
      ...
      #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    get_books_by_generes_validation(
        query_params,
    )
  ).await.unwrap();
  ...
  let result = api_impl.as_ref().get_books_by_generes(
      method,
      host,
      cookies,
        query_params,
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::book::GetBooksByGeneresResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
...
fn get_books_by_status_validation(
  ...
  models::GetBooksByStatusQueryParams,
), ValidationErrors>
{
  query_params.validate()?;
    ...
    A: apis::book::Book,
{
      ...
      #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    get_books_by_status_validation(
        query_params,
    )
  ).await.unwrap();
  ...
  let result = api_impl.as_ref().get_books_by_status(
      method,
      host,
      cookies,
        query_params,
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::book::GetBooksByStatusResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
...
fn update_book_validation(
  ...
  models::UpdateBookPathParams,
        models::BookProperties,
), ValidationErrors>
{
  path_params.validate()?;
    ...
    A: apis::book::Book,
{
  ...
  let result = api_impl.as_ref().update_book(
      method,
      host,
      cookies,
        path_params,
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::book::UpdateBookResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
    ...
    A: apis::discount::Discount,
{
  ...
  let result = api_impl.as_ref().add_discount(
      method,
      host,
      cookies,
              body,
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::discount::AddDiscountResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
...
fn delete_discount_validation(
  ...
  models::DeleteDiscountPathParams,
), ValidationErrors>
{
  path_params.validate()?;
    ...
    A: apis::discount::Discount,
{
  ...
  let result = api_impl.as_ref().delete_discount(
      method,
      host,
      cookies,
        path_params,
...
fn get_discount_by_id_validation(
  ...
  models::GetDiscountByIdPathParams,
), ValidationErrors>
{
  path_params.validate()?;
    ...
    A: apis::discount::Discount,
{
  ...
  let result = api_impl.as_ref().get_discount_by_id(
      method,
      host,
      cookies,
        path_params,
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::discount::GetDiscountByIdResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
    ...
    A: apis::discount::Discount,
{
  ...
  let result = api_impl.as_ref().update_discount(
      method,
      host,
      cookies,
        path_params,
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::discount::UpdateDiscountResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
...
fn update_order_validation(
  ...
  models::UpdateOrderPathParams,
        models::OrderProperties,
), ValidationErrors>
{
  path_params.validate()?;
    ...
    A: apis::store::Store,
{
  ...
  let result = api_impl.as_ref().update_order(
      method,
      host,
      cookies,
        path_params,
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::store::UpdateOrderResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
